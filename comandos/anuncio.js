module.exports = (client,message,args)=>{
  ...
  client.channels.cache.get('6112515958874540').send('@everyone')
  client.channels.cache.get('1251251595887450').send(embed); //Enviamos el embed (anuncio) a un canal por ID
